            ...
            <AnimatePresence>
              {userOpen ? (
                ...
                >
                  ...
                  <button className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm font-bold text-rose-600 transition hover:bg-rose-500/10 dark:text-rose-200" onClick={onLogout}>
